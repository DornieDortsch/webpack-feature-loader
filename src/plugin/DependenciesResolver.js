module.exports = (extRegExp, changeDependencies) => {
    ...
    const createResolveDependenciesWrapper = wrappedResolveDependencies => (fs, options, callback) => {
        wrappedResolveDependencies(fs, options, afterResolveDependencies(callback))
    }
